...
public partial class WorkforcedbDevContext : DbContext
{
    public WorkforcedbDevContext()
    {
    }

    public WorkforcedbDevContext(DbContextOptions<WorkforcedbDevContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=acer;Database=workforcedb-dev;User Id=sa;Password=123;Encrypt=True;TrustServerCertificate=True;Command Timeout=300");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC074E3E2D95");
