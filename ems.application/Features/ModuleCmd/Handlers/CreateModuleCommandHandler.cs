...
{
    public class CreateModuleCommandHandler : IRequestHandler<CreateModuleCommand, ApiResponse<ModuleResponseDTO>>
    {
        ...
        public async Task<ApiResponse<ModuleResponseDTO>> Handle(CreateModuleCommand request, CancellationToken cancellationToken)
        {
            try
            {
                // ✅ DTO to Entity mapping
                var moduleEntity = _mapper.Map<Module>(request.createModuleRequestDTO);
