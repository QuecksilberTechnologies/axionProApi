...
{
    public class UpdateModuleOperationConfigurationCommand : IRequest<ApiResponse<ModuleResponseDTO>>
    {

        public CreateModuleRequestDTO createModuleRequestDTO { get; set; }

        public UpdateModuleOperationConfigurationCommand(CreateModuleRequestDTO createModuleRequestDTO)
        {
