...
{
    public class UpdateEmployeeBankDetailWithAccessCommand : IRequest<ApiResponse<bool>>
    {
        public UpdateGenricAllEmployeeEntityRequestDTO updateEmployeeInfoWithAccessRequest { get; set; }

        public UpdateEmployeeBankDetailWithAccessCommand(UpdateGenricAllEmployeeEntityRequestDTO dto)
        {
