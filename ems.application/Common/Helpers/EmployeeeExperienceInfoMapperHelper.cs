...
{
    public static class EmployeeeExperienceInfoMapperHelper
    {
        public static GetEmployeeExperienceInfoWithAccessResponseDTO ConvertToAccessResponseDTO<T>(T source)
        {
            var result = new GetEmployeeExperienceInfoWithAccessResponseDTO();

            var sourceProps = typeof(T).GetProperties();
            var targetProps = typeof(GetEmployeeExperienceInfoWithAccessResponseDTO).GetProperties();
