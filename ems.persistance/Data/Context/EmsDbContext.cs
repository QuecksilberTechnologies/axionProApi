...
namespace ems.persistance.Data.Context
{
    public class EmsDbContext : DbContext, IEmsDbContext
    {
        ...
        public virtual DbSet<EmsModuleDetail> EmsModuleDetails { get; set; }

        public virtual DbSet<EmsSubModuleDetail> EmsSubModuleDetails { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmsModuleDetail>(entity =>
            {
                entity.HasKey(e => e.Id).HasName("PK__ProjectM__3214EC078CBD7460");

                entity.ToTable("EmsModuleDetail", "emp");
            ...
            modelBuilder.Entity<EmsSubModuleDetail>(entity =>
            {
                entity.HasKey(e => e.Id).HasName("PK__ProjectS__3214EC07F684FD7B");

                entity.ToTable("EmsSubModuleDetail", "emp");
